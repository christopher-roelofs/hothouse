...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "PlantTycoon", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Plant Tycoon";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Plant Tycoon", null, { width: 640, height: 480 });
